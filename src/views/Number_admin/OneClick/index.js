...
class OneClick extends Component {
  ...
  activate = async () => {
    ...
    if (num === null || num === "") {
      reserve_message = search_reserve_numbers(this.props.somos.id, this.props.somos.selectRo, qt, npa, nxx, line, num, cont, this.state.ncon, this.state.ctel, this.state.notes);
    } else {
      reserve_message = search_reserve_ten_numbers(this.props.somos.id, this.props.somos.selectRo, fix_num(num), this.state.ncon, this.state.ctel, this.state.notes)
    }
    ...
    if (res.ok && res.data && res.data.message) {
      ...
      let customer_message = customer_create(this.props.somos.id, this.props.somos.selectRo, fix_num(this.state.reserved_number), this.state.startDate.format("MM/DD/YYYY").toString(), this.state.et, this.state.ctel, this.state.ncon, this.state.template, this.state.timezone, this.state.now, this.state.service_order, this.state.lns);
