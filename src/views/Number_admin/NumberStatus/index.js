...
class NumberStatus extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isEt: false, isUntil: false, isNcon: false, isCtel: false, isNotes: false, isNum: true, ro: "", status: "", ed: "", until: "", ncon: "", ctel: "", notes: "", isResult: false, isState: false, originRo: null
    };
  }
  ...
  queryNumber = async () => {
    ...
    let message = query_number(this.props.somos.id, this.props.somos.selectRo, fix_num(num));
    console.log(message);
  ...
  updateQuery = async () => {
    ...
    if (this.state.ro !== this.state.originRo) {ro = this.state.originRo;}
    let message = number_status(this.props.somos.id, this.props.somos.selectRo, fix_num(this.state.num), this.state.ro, this.state.ncon, this.state.ctel, this.state.notes,
      this.state.until, this.state.status, ro);
    console.log(message);
