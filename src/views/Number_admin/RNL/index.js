...
class RNL extends Component {
  constructor(props) {
    super(props);
    this.state = {
      template: null, isTem: true, data: [], page: 0, sort: [],
                ...
                <FormGroup row>
                  <Col xs="6">
                    <ReactTable
                      ...
                      getTrProps={(state, rowInfo) => {
                        return {
                          onClick: () => {
                            this.getNumberDetail(rowInfo.original.number)
                          }
                        }
                      }}
                    />
                  ...
                  <Col xs="6">
                    <FormGroup row>
                      ...
                      <Col xs="9"><Input type="text" defaultValue={this.state.ncon}/></Col>
                    </FormGroup>
                    <FormGroup row>
                      <Col xs="3"><Label>Contact Number:</Label></Col>
                      <Col xs="6"><Input type="text" defaultValue={this.state.ctel}/></Col>
                    </FormGroup>
                    <FormGroup row>
                      <Col xs="3">
